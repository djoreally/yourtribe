...
function SignInContent() {
  ...
  return (
    <main className="grid min-h-screen bg-[#f6f7f2] lg:grid-cols-[1.08fr_0.92fr]">
      <section className="hidden bg-[#17382f] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <Link href="/" className="flex items-center gap-2.5"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#d9ff5a] font-[family-name:var(--font-display)] text-sm font-extrabold tracking-[-0.1em] text-[#17382f]">CP</span><span className="font-[family-name:var(--font-display)] text-xl font-bold tracking-[-0.06em]">Content Pyramid</span></Link>
        <div className="max-w-md"><p className="text-xs font-bold uppercase tracking-[0.16em] text-[#b9cbbf]">Manager workspace</p><h1 className="mt-4 font-[family-name:var(--font-display)] text-6xl font-bold leading-[0.92] tracking-[-0.075em] text-white">Keep the best moments moving.</h1><p className="mt-6 text-lg leading-8 text-[#cfddd5]">Review community uploads, protect your brand, and distribute with confidence.</p></div>
        <p className="text-sm font-semibold text-[#b9cbbf]">Your team owns the story. We make the workflow simple.</p>
      </section>
      <section className="flex items-center justify-center p-5 sm:p-8">
        <div className="w-full max-w-md">
          <Link href="/" className="mb-12 inline-flex items-center gap-2 text-sm font-bold text-[#5b7066] transition hover:text-[#17382f] lg:hidden"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#17382f] font-[family-name:var(--font-display)] text-[11px] font-extrabold tracking-[-0.1em] text-[#d9ff5a]">CP</span> Content Pyramid</Link>
          <div className="rounded-[2rem] border border-[#dce5df] bg-white p-6 shadow-[0_20px_60px_rgba(18,45,38,0.09)] sm:p-8">
            ...
            <p className="mt-6 text-center text-sm text-[#6a7d73]">New to Content Pyramid? <Link href="/sign-up" className="font-bold text-[#244e3d] hover:underline">Create an account</Link></p>
          </div>
        </div>
      </section>
    </main>
...
export default function SignInPage() {
  return <Suspense fallback={<main className="min-h-screen bg-[#f6f7f2]" />}><SignInContent /></Suspense>;
}
